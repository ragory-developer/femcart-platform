...
### Overview
Femcart uses an external SMS gateway (MassData) to send OTP codes and order status notifications.
...
TO: 01XXXXXXXXX
TEXT: Your Femcart verification code is: 123456
====================
```
...
|-------|---------|-----------------|
| OTP send | `"Your Femcart verification code is: XXXXXX"` | No |

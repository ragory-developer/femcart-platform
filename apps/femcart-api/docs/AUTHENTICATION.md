...
Femcart uses **JWT (JSON Web Token)** based authentication with a dual-token strategy (access + refresh tokens). Additionally, it supports **OTP-based phone authentication** for guest and mobile-first checkout flows.

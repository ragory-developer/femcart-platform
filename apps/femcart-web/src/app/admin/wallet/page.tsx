...
import { ArrowDownCircle, ArrowUpCircle, Clock, History, Loader2, Plus, Wallet, X } from "lucide-react";
    ...
    <div className="space-y-6 pb-10">
      ...
      <div>
        ...
        <p className="text-gray-500 dark:text-gray-400 mt-1">
          Monitor your operations fund, view transaction history, and top-up credits.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white dark:bg-gray-900 rounded-[2rem] border border-gray-100 dark:border-gray-800 p-8 shadow-sm overflow-hidden relative">
           ...
           <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h3 className="text-xl font-black text-gray-900 dark:text-white uppercase tracking-tighter italic">The Vault</h3>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-[2rem] border border-gray-100 dark:border-gray-800 p-8 shadow-sm overflow-hidden relative flex flex-col justify-center items-center text-center">
           ...
           <h3 className="text-xl font-black text-gray-900 dark:text-white mb-2">Need More Credits?</h3>
           <p className="text-sm text-gray-500 dark:text-gray-400 mb-8 max-w-[200px]">
              Instantly recharge your global wallet to keep operations running smoothly.
           </p>
           <button 
            ...
            <table className="w-full text-left border-collapse min-w-[800px] text-sm">
              <thead>
                <tr className="bg-gray-50/80 dark:bg-gray-800/80">
                  <th className="px-6 py-3.5 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider align-middle border border-gray-200 dark:border-gray-700 whitespace-nowrap">Date & Time</th>
                  <th className="px-6 py-3.5 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider align-middle border border-gray-200 dark:border-gray-700">Type</th>
                  <th className="px-6 py-3.5 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider align-middle border border-gray-200 dark:border-gray-700">Amount</th>
                  <th className="px-6 py-3.5 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider align-middle border border-gray-200 dark:border-gray-700">Purpose</th>
                </tr>
              </thead>
              <tbody>
                {transactions.map((tx) => (
                  <tr key={tx.id} className="group transition-colors duration-200 hover:bg-gray-50/80 dark:hover:bg-gray-750/30">

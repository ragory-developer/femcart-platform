    ...
    <div className="max-w-4xl space-y-8 animate-in fade-in duration-300">
      <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-6 md:p-8 shadow-sm">
        <div className="border-b border-gray-100 dark:border-gray-750 pb-4 mb-6">
          ...
          <p className="text-sm text-gray-500 mt-1">Basic details about your product.</p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="relative">
            ...
            {slugWarning ? (
              ...
              <p className="absolute top-full left-0 mt-1 text-[11px] text-gray-500">Custom URL identifier. Must be unique. Only lowercase letters, numbers, and hyphens.</p>
            )}
          </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-6 md:p-8 shadow-sm">
        <div className="border-b border-gray-100 dark:border-gray-750 pb-4 mb-6">
          ...
          <p className="text-sm text-gray-500 mt-1">Set the regular and special prices for this product.</p>
        </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-6 md:p-8 shadow-sm">
        <div className="border-b border-gray-100 dark:border-gray-750 pb-4 mb-6">
          ...
          <p className="text-sm text-gray-500 mt-1">Categorize and label your product for better discoverability.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <div>
              <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1.5">Halal Status</label>
              <Controller
                name="isHalal"
                control={control}
                render={({ field }) => (

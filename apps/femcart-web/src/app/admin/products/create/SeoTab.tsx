    ...
    <div className="max-w-4xl space-y-8 animate-in fade-in duration-300">
      <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-6 md:p-8 shadow-sm">
        <div className="border-b border-gray-100 dark:border-gray-750 pb-4 mb-6">
          <h2 className="text-xl font-bold text-gray-900 dark:text-white">Search Engine Optimization</h2>
          <p className="text-sm text-gray-500 mt-1">Configure how this product appears in search engine results.</p>
        </div>
        ...
        <div className="space-y-6">
          <div className="relative">
            ...
            {errors.slug ? (
              ...
              <p className="absolute top-full left-0 mt-1 text-[11px] text-gray-500">Leave blank to auto-generate from the product name.</p>
            )}
          </div>

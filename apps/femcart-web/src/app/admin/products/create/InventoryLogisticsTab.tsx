    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
      <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-6 md:p-8 shadow-sm">
        <div className="border-b border-gray-100 dark:border-gray-750 pb-4 mb-6">
          <h3 className="text-xl font-bold text-gray-900 dark:text-white">Inventory & Stock</h3>
          <p className="text-sm text-gray-500 mt-1">Manage stock levels and track inventory using SKU.</p>
        </div>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="relative">
            <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1.5">SKU (Stock Keeping Unit)</label>
            <input 
              type="text" 
              {...register("sku")}
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-6 md:p-8 shadow-sm">
        <div className="border-b border-gray-100 dark:border-gray-750 pb-4 mb-6">
          <h3 className="text-xl font-bold text-gray-900 dark:text-white">Logistics & Shipping</h3>
          <p className="text-sm text-gray-500 mt-1">Configure unit types, weight, and origin for delivery logistics.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1.5">Country of Origin</label>
            <input 
              type="text" 

              ...
              >
                  ...
                  <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-[2.5rem] p-8 md:p-12 shadow-xl shadow-gray-200/20 dark:shadow-none">
                    ...
                    <div className="mb-10 flex flex-col sm:flex-row items-center gap-6">
                      ...
                      <div className="text-center sm:text-left">
                        ...
                        <p className="text-sm text-gray-500 mt-1">PNG, JPG or WebP under 2MB</p>
                      </div>
                    </div>
                ...
                {activeTab === 'notifications' && (
                  <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-[2.5rem] p-12 shadow-xl shadow-gray-200/20 dark:shadow-none">
                    ...
                    <div className="space-y-6">
                      {[
                        { key: 'orderUpdates', title: 'Order Updates', desc: 'Get notified about your order status changes' },
                        { key: 'promotions', title: 'Promotions', desc: 'Receive info about sales and special offers' },
                        { key: 'newsletter', title: 'Newsletter', desc: 'Weekly digest of our best products' },
                      ].map((item) => (
                        <div key={item.key} className="flex items-center justify-between py-6 border-b border-gray-50 dark:border-gray-800 last:border-0">
                          <div>
                ...
                {activeTab === 'security' && (
                   <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-[2.5rem] p-8 md:p-12 shadow-xl shadow-gray-200/20 dark:shadow-none">
                    ...
                    <div className="p-6 md:p-8 bg-blue-50 dark:bg-blue-900/10 rounded-3xl border border-blue-100 dark:border-blue-900/30 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 mb-8">
                       <div className="flex items-center gap-4 md:gap-6">
                          ...
                          <div>
                             ...
                             <p className="text-xs text-gray-500 font-bold uppercase tracking-widest mt-1">Keep your account secure</p>
                          </div>
                       </div>
                       <button 
                    ...
                    {isPasswordFormVisible && (
                      <form onSubmit={handlePasswordSubmit} className="max-w-md space-y-6 bg-gray-50 dark:bg-gray-950 p-6 md:p-8 rounded-3xl border border-gray-100 dark:border-gray-800">
                        <div>
                          <label className="block text-xs font-black text-gray-400 uppercase tracking-[0.2em] mb-2 ml-1">Current Password</label>
                          <input 
                            type="password"
                            required
                            value={oldPassword}
                        ...
                        <div>
                          <label className="block text-xs font-black text-gray-400 uppercase tracking-[0.2em] mb-2 ml-1">New Password</label>
                          <input 
                            type="password"
                            required
                            value={newPassword}
                        ...
                        <div>
                          <label className="block text-xs font-black text-gray-400 uppercase tracking-[0.2em] mb-2 ml-1">Confirm New Password</label>
                          <input 
                            type="password"
                            required

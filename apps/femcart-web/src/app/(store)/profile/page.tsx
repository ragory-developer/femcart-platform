                ...
                <div className="bg-white dark:bg-gray-900 rounded-[2rem] border border-gray-100 dark:border-gray-800 overflow-hidden shadow-sm">
                  <div className="p-8 border-b border-gray-100 dark:border-gray-800 bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-900/10 dark:to-orange-900/10 flex flex-col sm:flex-row items-center gap-6">
                    ...
                    <div className="text-center sm:text-left flex-1">
                      <h2 className="text-3xl font-black text-gray-900 dark:text-white tracking-tight">Guest User</h2>
                      <p className="text-sm text-gray-500 dark:text-gray-400 mt-2 max-w-md">
                        Upgrade to a full account to access rewards, leave reviews, save items to your wishlist, and get a personalized shopping experience!
                      </p>
                    </div>
                  </div>

                  <div className="p-8">
                    <h3 className="text-lg font-black uppercase italic tracking-tighter mb-6 text-gray-400 dark:text-gray-500">Contact Information</h3>
              ...
              <>
                ...
                <div className="bg-white dark:bg-gray-900 rounded-[2rem] border border-gray-100 dark:border-gray-800 overflow-hidden shadow-sm">
                  ...
                  <div className="p-8">
                    ...
                    <h3 className="text-lg font-black uppercase italic tracking-tighter mb-6 text-gray-400 dark:text-gray-500">Additional Details</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="flex gap-4">
                        ...
                        <div>
                          <p className="text-sm text-gray-500 font-bold uppercase tracking-wider">Joined Date</p>
                          <p className="text-gray-900 dark:text-white font-medium">
                            {/* If createdAt doesn't exist on context, fallback to static text */}
                            {user.createdAt ? new Date(user.createdAt).toLocaleDateString('en-GB', { day: 'numeric', month: 'long', year: 'numeric' }) : "Recently"}
                          </p>
                        </div>
                      </div>
                    </div>

        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-gray-600 dark:text-gray-400 leading-relaxed font-medium mx-auto max-w-2xl">
              Have a question about your order, our fresh produce, or just want to say hi? Send us a message.
            </p>
          </div>
        </div>
      </div>
            ...
            <div className="lg:col-span-5 flex flex-col gap-8">
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="p-8 bg-[#fcfaf8] dark:bg-gray-900 rounded-[2rem] border border-gray-100 dark:border-gray-800 shadow-sm flex items-start gap-6 hover:-translate-y-1 hover:border-[#13A048] hover:shadow-lg hover:shadow-[#13A048]/10 transition-all duration-300">
                  ...
                  <div>
                    <h4 className="text-xl font-bold text-[#0F3A44] dark:text-white mb-2">Our Store</h4>
                    <p suppressHydrationWarning className="text-gray-600 dark:text-gray-400 leading-relaxed whitespace-pre-line">
                      {settings.footer_address || "123 Fresh Market Ave, Suite 100\nGreen City, GC 10001"}
                    </p>
                  </div>
                </div>
                ...
                <div className="p-8 bg-[#fcfaf8] dark:bg-gray-900 rounded-[2rem] border border-gray-100 dark:border-gray-800 shadow-sm flex items-start gap-6 hover:-translate-y-1 hover:border-[#13A048] hover:shadow-lg hover:shadow-[#13A048]/10 transition-all duration-300">
                  ...
                  <div>
                    <h4 className="text-xl font-bold text-[#0F3A44] dark:text-white mb-2">Call Us</h4>
                    <p suppressHydrationWarning className="text-gray-600 dark:text-gray-400 leading-relaxed">
                      {settings.footer_phone || "+1 (800) 123-4567"}
                    </p>
                    <p className="text-sm text-[#13A048] font-semibold mt-2 uppercase tracking-wide">Mon-Sun: 9am - 8pm</p>
                  </div>
                </div>
                ...
                <div className="p-8 bg-[#fcfaf8] dark:bg-gray-900 rounded-[2rem] border border-gray-100 dark:border-gray-800 shadow-sm flex items-start gap-6 hover:-translate-y-1 hover:border-[#13A048] hover:shadow-lg hover:shadow-[#13A048]/10 transition-all duration-300">
                  ...
                  <div>
                    <h4 className="text-xl font-bold text-[#0F3A44] dark:text-white mb-2">Email Us</h4>
                    <p suppressHydrationWarning className="text-gray-600 dark:text-gray-400 leading-relaxed">
                      {settings.footer_email || "support@femcart.com"}
                    </p>
                    <p className="text-sm text-[#13A048] font-semibold mt-2 uppercase tracking-wide">We reply within 24 hours</p>
                  </div>
                </div>
              </div>
            </div>
                  ...
                  <div className="pt-4">
                    ...
                    >
                      {isSubmitting ? (
                        ...
                        <>
                          <Send size={20} className="group-hover:-translate-y-1 group-hover:translate-x-1 transition-transform" /> Send Message
                        </>
                      )}
                    </button>
                  </div>

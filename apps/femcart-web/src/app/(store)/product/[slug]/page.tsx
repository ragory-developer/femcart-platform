...
import ProductDetailPage, { generateMetadata as templateGenerateMetadata } from "@/components/product/shared/ProductPageTemplate";
...
export default async function ProductSlugPage(props: any) {
  ...
  if (settings.permalink_structure === 'flat' || !settings.permalink_structure) {

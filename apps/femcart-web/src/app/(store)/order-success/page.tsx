...
import { ArrowRight, Banknote, CheckCircle2, Loader2, MapPin, Receipt, ShoppingBag } from "lucide-react";
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-gray-500 dark:text-gray-400 font-medium max-w-lg mx-auto">
            Thank you for choosing Femcart. Your order has been successfully placed and is now being processed.
          </p>
        </div>
          ...
          <div className="flex-1 space-y-6">
            ...
            {orderId && (
              <div className="bg-white dark:bg-gray-900 rounded-3xl p-6 md:p-8 border border-gray-200 dark:border-gray-800 shadow-sm flex items-center justify-between">
                <div>
                  <div className="text-xs font-black uppercase tracking-widest text-gray-400 mb-1">Order Number</div>
                  <div className="text-xl font-mono font-black text-gray-900 dark:text-white">#{orderId}</div>
                </div>
                {order && (
                  <div className="text-right">
                    <div className="text-xs font-black uppercase tracking-widest text-gray-400 mb-1">Date</div>
              ...
              <>
                ...
                {order.paymentMethod === 'COD' && (
                  <div className="bg-amber-50 dark:bg-amber-900/10 rounded-3xl p-6 md:p-8 border border-amber-200 dark:border-amber-800 shadow-sm">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h3 className="text-lg font-black text-amber-900 dark:text-amber-500 mb-2 uppercase tracking-tight">Cash on Delivery</h3>
                        <p className="text-amber-800/80 dark:text-amber-400/80 text-sm font-medium leading-relaxed">
                          Please keep the exact amount of <strong>৳{order.total?.toFixed(2)}</strong> ready at the time of delivery. Our delivery executive will contact you shortly before arriving at your address.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="bg-white dark:bg-gray-900 rounded-3xl p-6 md:p-8 border border-gray-200 dark:border-gray-800 shadow-sm">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h3 className="text-xl font-black text-gray-900 dark:text-white uppercase tracking-tighter italic">Delivery Details</h3>
                  </div>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                      <div className="text-xs font-bold uppercase tracking-wider text-gray-400 mb-1">Recipient</div>
                      <div className="font-bold text-gray-900 dark:text-white">{order.customerName || "N/A"}</div>
                      <div className="text-gray-500 text-sm mt-1">{order.customerPhone || "N/A"}</div>
                    </div>
                    <div>
                      <div className="text-xs font-bold uppercase tracking-wider text-gray-400 mb-1">Shipping Address</div>

...
async function getProducts(searchParams: any) {
  try {
    ...
    query.set("category", "fresh-meat"); // Hardcode category
...
export default async function HalalMeatPage({ 
  searchParams 
}: { 
  ...
  fetchUrl.searchParams.set("category", "fresh-meat"); // Hardcode category
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-20 border-b border-[#0F3A44]/10 dark:border-gray-900 pb-12">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-6 font-medium max-w-xl text-lg leading-relaxed">
              100% Hand-slaughtered Zabiha Halal Meat. Freshly cut to your preference and delivered straight to your door.
            </p>
          </div>
        </div>

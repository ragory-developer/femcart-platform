...
export const variantSchema = z.object({
  ...
  price: z.string().min(1, "Price required").refine(val => !isNaN(parseFloat(val)), "Invalid price"),
  specialPrice: z.string().optional().refine(val => !val || !isNaN(parseFloat(val)), "Invalid special price"),
  specialPriceStart: z.string().optional(),
  specialPriceEnd: z.string().optional(),
  stock: z.string().optional().refine(val => !val || !isNaN(parseInt(val)), "Invalid stock number").default("0"),
...
export const productSchema = z.object({
  ...
  price: z.string().min(1, "Price is required").refine(val => !isNaN(parseFloat(val)), "Invalid price"),
  specialPrice: z.string().optional().refine(val => !val || !isNaN(parseFloat(val)), "Invalid special price"),
  specialPriceStart: z.string().optional(),
  specialPriceEnd: z.string().optional(),
  stock: z.string().optional().refine(val => !val || !isNaN(parseInt(val)), "Invalid stock number").default("0"),

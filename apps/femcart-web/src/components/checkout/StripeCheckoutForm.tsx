...
export default function StripeCheckoutForm({ onSuccess, onError }: StripeCheckoutFormProps) {
  ...
  return (
    <form id="stripe-payment-form" onSubmit={handleSubmit} className="w-full mt-4">
      ...
      <button type="submit" id="stripe-submit-hidden" className="hidden" disabled={isProcessing || !stripe || !elements}>
        Submit
      </button>

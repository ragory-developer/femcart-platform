      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
        ...
        >
          ...
          <div className="text-center">
            <h3 className="font-bold text-base lg:text-lg text-gray-900 dark:text-white">Order as Guest</h3>
            <p className="text-xs lg:text-sm text-gray-500 dark:text-gray-400 mt-1">Quick checkout with email verification</p>
          </div>
        </button>
        ...
        >
          ...
          <div className="text-center">
            <h3 className="font-bold text-base lg:text-lg text-gray-900 dark:text-white">Sign In / Register</h3>
            <p className="text-xs lg:text-sm text-gray-500 dark:text-gray-400 mt-1">Access saved addresses and order history</p>
          </div>
        </button>
      </div>
    </div>

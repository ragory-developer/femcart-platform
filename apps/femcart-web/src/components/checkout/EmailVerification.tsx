...
export default function EmailVerification({ onVerified, onCancel }: EmailVerificationProps) {
    ...
    <div className="bg-white dark:bg-gray-800 rounded-xl p-[clamp(1.25rem,4vw,2rem)] shadow-sm border border-gray-100 dark:border-gray-700 relative">
      ...
      {step === 'input' ? (
        <form onSubmit={handleSendOtp} className="space-y-5">
          ...
          <div>
            <label className="block text-[clamp(0.875rem,2vw,1rem)] font-bold text-gray-700 dark:text-gray-300 mb-2">Email Address</label>
            <div className="relative">
            ...
            {isRegisteredUser ? (
              <>
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">
                  A user with the email <span className="font-bold text-gray-900 dark:text-white">{email}</span> already exists in our system. You can securely login with your Email/ID and Password.
                </p>

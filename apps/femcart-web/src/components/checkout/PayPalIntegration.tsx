...
export default function PayPalIntegration({ orderDataPayload, onSuccess, onError }: PayPalIntegrationProps) {
        ...
        createOrder={async (data, actions) => {
          ...
          try {
            ...
            if (result.success && result.paymentData?.orderId) {
              ...
              showToast.error(result.message || "Failed to initialize PayPal order");

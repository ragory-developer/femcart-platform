...
export default function Reviews({
  ...
  return (
    <section className="max-w-[1440px] mx-auto px-4 md:px-6 mb-4 md:mb-16">
      ...
      >
        <img src={bannerImage} alt="Happy Customers" className="absolute inset-0 w-full h-full object-cover object-center" />
        ...
        <div className="relative z-10 w-full max-w-2xl">
          <h2 className="font-serif text-[28px] md:text-[48px] text-white mb-2 md:mb-4 leading-tight shadow-sm">{bannerTitle}</h2>
          <p className="text-white/95 text-[14px] md:text-[16px] leading-snug md:leading-normal max-w-xl mx-auto font-medium shadow-sm">{bannerDesc}</p>
        </div>
      </motion.div>
        ...
        {chats && chats[0] && (
          ...
          >
            <div className="bg-pink-500 text-white p-4 flex items-center gap-3">
              <div className="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center">{chats[0].initial}</div>
              <div>
        ...
        {chats && chats[1] && (
          ...
          >
            <div className="bg-[#2C2C2E] p-4 flex items-center gap-3 border-b border-[#333]">
              <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-blue-500 to-purple-500 flex items-center justify-center text-white">{chats[1].initial}</div>
              <div>

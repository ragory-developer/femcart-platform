  ...
  return (
    <section className="mb-8 md:mb-16">
      <div className="relative h-[300px] md:h-[400px] w-full flex items-center justify-center">
        <img 
          src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?q=80&w=1440&auto=format&fit=crop" 
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center p-6 max-w-xl">
          <span className="text-white text-[13px] font-semibold tracking-[0.2em] uppercase mb-3">Editorial</span>
          ...
          <button className="inline-flex items-center justify-center h-12 px-6 rounded-full font-sans font-semibold text-[15px] tracking-[0.3px] transition-all duration-150 cursor-pointer bg-pink-500 text-white hover:bg-pink-600 active:scale-[0.98]">Explore the Edit</button>
        </div>
      </div>
    </section>
  );

  ...
  return (
    <section className="bg-rose-50 py-6 md:py-16 mb-4 md:mb-16">
      <div className="max-w-[1440px] mx-auto px-4 md:px-6 max-w-2xl text-center">
        <h2 className="font-serif text-[32px] md:text-[40px] mb-2 md:mb-4">{title}</h2>
        <p className="text-[13px] md:text-[15px] leading-snug md:leading-normal text-text-amber-700 mb-6 md:mb-8">{description}</p>

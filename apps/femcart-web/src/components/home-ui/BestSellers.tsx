      ...
      <div className="max-w-[1440px] mx-auto px-4 md:px-6">
        ...
        >
          <div className="flex justify-between items-end mb-4 md:mb-8">
            <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl">Best Sellers</h2>
            <Link href="/catalog" className="hidden md:inline-flex items-center justify-center h-12 px-6 rounded-full font-sans font-semibold text-[14px] tracking-[0.3px] transition-all duration-150 cursor-pointer bg-transparent text-pink-500">Shop All &rarr;</Link>
          </div>

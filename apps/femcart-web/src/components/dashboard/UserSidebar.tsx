      ...
      <nav className="flex flex-col gap-2">
          ...
          return (
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <span className="font-bold text-[clamp(0.875rem,2vw,1rem)] tracking-tight">{item.label}</span>
              </div>
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <span className="font-bold text-[clamp(0.875rem,2vw,1rem)] tracking-tight">Logout</span>
          </div>
        </button>
      </nav>
    </div>

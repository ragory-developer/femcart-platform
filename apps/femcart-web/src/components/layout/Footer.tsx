...
import { Facebook, Instagram, Twitter, MapPin, Phone, Mail, CreditCard, Send, Loader2, CheckCircle2, AlertCircle } from "lucide-react";
      ...
      <div className="max-w-[1600px] mx-auto px-4 md:px-6">
        ...
        <div className="bg-red-50 rounded-sm p-8 md:p-12 mb-12 flex flex-col lg:flex-row items-center justify-between gap-8 border border-red-100">
          ...
          <div className="w-full lg:w-auto relative">
            <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 w-full sm:w-[450px]">
              <input
                type="email"
                required
                value={email}
        ...
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-10 mb-12 text-center md:text-left">
          ...
          <div className="col-span-2 md:col-span-1 lg:col-span-1 space-y-6 lg:pr-8 flex flex-col items-center md:items-start">
            ...
            <p className="text-gray-500 text-[14px] md:text-[15px] leading-relaxed font-medium">
              {settings.footer_about_text || "The fastest premium grocery delivery service. Fresh produce, organic items, and halal meats delivered straight to your door."}
            </p>

            {/* Socials */}
            <div className="flex gap-3 justify-center md:justify-start">
              <a href="#" className="w-11 h-11 rounded-full bg-gray-50 flex items-center justify-center text-gray-500 hover:bg-[#1877F2] hover:text-white transition-all shadow-sm">
                <Facebook size={18} />
              </a>
              <a href="#" className="w-11 h-11 rounded-full bg-gray-50 flex items-center justify-center text-gray-500 hover:bg-[#1DA1F2] hover:text-white transition-all shadow-sm">
                <Twitter size={18} />
              </a>
              <a href="#" className="w-11 h-11 rounded-full bg-gray-50 flex items-center justify-center text-gray-500 hover:bg-[#E4405F] hover:text-white transition-all shadow-sm">
                <Instagram size={18} />
              </a>
            </div>
          </div>
        ...
        <div className="pt-8 border-t border-gray-100 flex flex-col md:flex-row justify-between items-center gap-6 text-[14px] text-gray-500 font-medium">
          <p>&copy; {new Date().getFullYear()} {settings.store_name || "Femcart"}. All rights reserved.</p>
          ...
          <div className="flex gap-2 items-center">
            <span className="px-3 py-1.5 bg-gray-50 border border-gray-100 rounded-lg font-bold text-gray-400 text-[11px] uppercase tracking-wider">Alpha Template</span>
          </div>
        </div>
